$(document).ready(function() {
	$(window).scroll(function(event) {
		...
		$(".parallax__mountain1").css('transform','scale('+z_2+')');

		let hr_1 = w/2000*p_b;
		let z_3 = 1+(w*0.000005*p_b);
		$(".parallax__mountain2").css('transform','translate3d('+hr_1+'px,0,0) scale('+z_3+')');

		let hr_2 = w/1500*p_b;
		let z_4 = 1+(w*0.00001*p_b);
		$(".parallax__mountain3").css('transform','translate3d('+hr_2+'px,0,0) scale('+z_4+')');
	});
});